...
const gamebord = document.querySelector('#gameborad');
...
function dragDrop(e){
    ...
    if(correctGo){
        ...
        //just if it exist in the square + replacing
...
function reverseIds(){
    const allSquares = document.querySelectorAll('.square')
    allSquares.forEach((squre,i)=>
    squre.setAttribute('square-id', (width * width - 1) - i))
...
function checkForWin(){
    ...
    if(!king.some(king => king.firstChild.classList.contains('white'))){
        ...
        const allSquares = document.querySelectorAll('.square')
       allSquares.forEach(square => square.firstChild?.setAttribute( 'dragganle', false)  )
    }
